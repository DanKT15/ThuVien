...
if (isset($_GET['id'])) 
{
	...
	if (isset($_POST['add'])) 
	{
		...
		$sql = "UPDATE sach SET ten = '$ten', hinhanh = '$hinhanh', noidung = '$noidung', tentl = '$theloai', tacgia = '$tacgia', gioithieu = '$gioithieu' WHERE id = $id;";
...
else 
{
	if (isset($_POST['add'])) 
	{
		...
		$sql = "INSERT INTO sach(ten, hinhanh, noidung, tentl, tacgia, gioithieu) 
		VALUES ('$ten', '$hinhanh', '$noidung', '$theloai', '$tacgia', '$gioithieu');";
		$sach = setsql($conn, $sql);
